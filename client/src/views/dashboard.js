         ...
         courses.map(course => (
            ...
            <div class="p-3">
                ...
                <ul class="list-unstyled m-0">
                   <li><i class="fa fa-graduation-cap"></i>Session</li>
                ...
                <div class="swiper sliderFeaturedPosts">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="single-post.html" class="img-bg d-flex align-items-end" style={{backgroundImage:"url('assets/img/post-slide-1.jpg')"}}>
                    ...
                    <div class="swiper-slide">
                      <a href="single-post.html" class="img-bg d-flex align-items-end" style={{backgroundImage:"url('assets/img/post-slide-2.jpg')"}}>
                        <div class="img-bg-inner">
                    ...
                    <div class="swiper-slide">
                      <a href="single-post.html" class="img-bg d-flex align-items-end"style={{backgroundImage:"url('assets/img/post-slide-4.jpg')"}}>
                        <div class="img-bg-inner">
