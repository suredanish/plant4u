                ...
                {popularBlogs?.length > 0 ? (
                  <>
                    <div className="post-meta">
                      <span className="date">
                        {popularBlogs[0].meta_description}
                      </span>
                      <span className="mx-1"></span>
                      <span>
                        {moment(popularBlogs[0].createdAt).format("MMM Do YY")}
                      </span>
                    </div>
                    <h2>
            ...
            <div className="col-lg-8">
              <div className="row g-5">
                <div className="col-lg-4 border-start custom-border">
                  {firstPriorityBlog &&
                    firstPriorityBlog.length > 0 &&
                    firstPriorityBlog.map((blog, i) => (
                      <div
                        className={`post-entry-1 ${i !== 0 ? "mt3" : ""}`}
                        key={blog.meta_description}
                      >
                        <div className="post-meta">
                ...
                <div className="col-lg-4 border-start custom-border">
                  {secongPriorityBlog &&
                    secongPriorityBlog.length > 0 &&
                    secongPriorityBlog.map((blog, i) => (
                      <div
                        className={`post-entry-1 ${i !== 0 ? "mt3" : ""}`}
                        key={blog.meta_description}
                      >
        ...
        <div className="container" data-aos="fade-up">
          ...
          <div className="row">
              ...
              <div className="d-lg-flex post-entry-2">
                ...
                >
                  <iframe
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/FLb4FHJAWhI?autoplay=1"
                    title="Beginner"
                    frameBorder="0"
                  ></iframe>
                </a>
                <div>
                  ...
                  <h3>
                    <a href="">
                      Gardening tips for beginners - expert advice to inspire
                      all budding gardeners
                    </a>
                  </h3>
                  <p>
                    "Gardening is a process", says Sullivan. "It does not just
                    happen in one day - it takes time". Sometimes impatience
                    will cause you to over water or fuss too much with the
                    plants in the hopes that they will grow faster.
                  </p>
                  <div className="d-flex align-items-center author">
                    <div className="photo">
                      {/* <img
              ...
              <div className="row">
                <div className="col-lg-4">
                  <div className="post-entry-1 border-bottom">
                    ...
                    <div className="post-meta">
                      <span className="date"></span> <span>March 5th '23</span>
                    </div>
                    <h2 className="mb-2">
                      <a href="">
                ...
                <div className="col-lg-8">
                  <div className="post-entry-1">
                    ...
                    <div className="post-meta">
                      <span className="date"></span> <span>March 3rd '23</span>
                    </div>
                    <h2 className="mb-2">
                      <a href="#">Balcony Design With Personal Touch</a>
                    </h2>
                    <span className="author mb-3 d-block">plant4u</span>
                    <p className="mb-4 d-block">
                      Turn your Space into peaceful green corner with these
                      beautiful plants
                    </p>
                  </div>
                </div>
            ...
            <div className="col-md-3">
              <div className="post-entry-1 border-bottom">
                <div className="post-meta">
                  <span className="date"></span> <span>1 march 2023</span>
                </div>
                <h2 className="mb-2">
                  <a href="#">10 cozy balcony ideas by plant4u</a>
                </h2>
                <div className="d-flex align-items-center author">
                  <div className="photo">
                    <img
              ...
              <div className="post-entry-1 border-bottom">
                <div className="post-meta">
                  <span className="date"></span> <span>3 march 2023</span>
                </div>
                <h2 className="mb-2">
                  <a href="#">5 Modern balcony Ideas by plant4u</a>
                </h2>
                <div className="d-flex align-items-center author">
                  <div className="photo">
                    <img
              ...
              <div className="post-entry-1 border-bottom">
                <div className="post-meta">
                  <span className="date"></span> <span>4 march 2023</span>
                </div>
                <h2 className="mb-2">
                  <a href="">10 unique Design for balcony by plant4u</a>
                </h2>
                <div className="d-flex align-items-center author">
                  <div className="photo">
                    <img
              ...
              <div className="post-entry-1 border-bottom">
                <div className="post-meta">
                  <span className="date"></span> <span>6 march 2023</span>
                </div>
                <h2 className="mb-2">
                  <a href="">5 terrace garden design by plant4u</a>
                </h2>
                <div className="d-flex align-items-center author">
                  <div className="photo">
                    <img
